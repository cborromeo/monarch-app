...
//end items copied from amigo.js
...
var pup_tent_dirs = [
                    ...
                    'node_modules/cytoscape/dist', // config contains phenogrid_config.js
...
function searchHandler(request, term, fmt) {
    ...
    try {
        ...
        if (info.results.length > 0){
            ...
            var suggestHead = "<h4>No results found, did you mean:</h4>";
            var suggestSpan = '';
            suggestions.forEach( function (suggestion) {
                var encodedSuggestion = encodeURI(suggestion);
                var href = "<a href=\"/search/" + encodedSuggestion +
                           "\">" + suggestion + "</a>";
                suggestSpan = suggestSpan + href + "</br>";
            });
            if (suggestSpan) {
                info.suggestSpan = suggestHead + suggestSpan;
            } else {
